...
<body>
  ...
  <img src="{{ asset('images/ipros.png') }}" alt="Logo" style="width: 200px; height: auto;">
                    ...
                    <li><a href="{{ route('formse') }}">FORMATION</a></li>
    ...
    <main>
        <div class="container">
            <section id="accueil" class="section-white">
                <p class="welcome-text">Bienvenue sur le site de l'Université IPROSI.</p>
                <img src="{{ asset('images/iprosi.jpg') }}" alt="Image d'accueil">
            </section>
